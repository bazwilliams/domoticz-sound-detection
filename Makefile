DOCKER := bazwilliams/domoticz-sound-detection
...
define label_dockerfile
	...
	@echo "      org.label-schema.name=\"Domoticz Sound Detection\" \\" >> $(1)
	...
	@echo "      org.label-schema.vcs-url=\"https://github.com/bazwilliams/domoticz-sound-detection\" \\" >> $(1)
